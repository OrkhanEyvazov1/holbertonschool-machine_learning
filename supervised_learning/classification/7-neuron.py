...
class Neuron:
    ...
    def train(self, X, Y, iterations=5000, alpha=0.05,
        ...
        Args:
            ...
            alpha: learning rate
            verbose: boolean that defines whether or not to print training info
            graph: boolean that defines whether or not to graph training info
            step: interval for printing and graphing costs
        Returns:
