...
class NeuralNetwork:
    ...
    def train(self, X, Y, iterations=5000, alpha=0.05,
        ...
        Args:
            ...
            alpha: learning rate
            verbose: defines if training information should be printed
            graph: defines if training information should be graphed
            step: interval for printing/graphing training data
        Returns:
        ...
        if graph:
            plt.plot(step_iters, step_costs, 'b')
