#!/usr/bin/env python3
"""
This module defines a sparse autoencoder model using Keras.
"""
...
def autoencoder(input_dims, hidden_layers, latent_dims, lambtha):
    """
    Creates a sparse autoencoder with L1 activity regularization.
    ...
    Args:
        ...
        lambtha (float): Regularization parameter for L1 activity
                         regularization.

    Returns:
        encoder (keras.Model): Encoder model.
        decoder (keras.Model): Decoder model.
        auto (keras.Model): Full sparse autoencoder model.
    """
